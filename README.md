...
Скачайте: файл OllamaSetup.exe (https://ollama.com/download/windows)
...
У меня было:
```C:\***\КРПО (Коллективная Разработка Программного Обеспечения)```
________________________________________
...
```
 У меня было:
```
cd "C:\***\КРПО (Коллективная Разработка Программного Обеспечения)\сайт"
php -S localhost:8000
```
________________________________________
